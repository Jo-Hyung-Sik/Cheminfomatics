...
from utils.standardizeutil import *

silence_tensorflow()
pd.set_option('display.max_columns', None)

featurizer = dc.feat.ConvMolFeaturizer(per_atom_fragmentation=False)
second_featurizer = dc.feat.MolGraphConvFeaturizer(use_edges=True)
...
class hERG_model:
    ...
    def run_model(self):
        ...
        start = time.time()
        save_dir = './deeplearning/model/central_' + str(k)
    ...
    def load_model(self):
        ...
        for i in range(1):
            ...
            model = GraphConvModel(1, mode='classification', batch_size=64, model_dir=path)
            model.restore()
