...
# file_list = ['2_2_all_padel_rdkit_desc_filter.csv']
...
for file_name in file_list:
    ...
    result_list.append([file_name, type(model).__name__, gscv.best_params_, train_r2, train_rmse, train_mae, test_r2, test_rmse, test_mae])
    
result_df = pd.DataFrame(result_list, columns=['data', 'model', 'parameter', 'trainR2', 'trainRMSE', 'trainMAE', 'testR2', 'testRMSE', 'testMAE'])
result_df.to_excel('./results/LightGBM_hyper_result.xlsx')